...
ConversationStore.prototype.getCurrentScoreForPlayer = function (convKey, convPlayer) {
    var score = 0,
        conversationPlayer = this._conversationStore[convKey][convPlayer];

    _.each(conversationPlayer, function(player){
            score += player.Score;
    });
